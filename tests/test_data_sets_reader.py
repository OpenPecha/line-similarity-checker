...
def test_datasets_reader():
    ...
    text_1 = batch_1.get_text("1-1-4a_line_9874_1")
    assert (
        text_1
        == "བདག་གི་ཁར་སྦྲེངས་ནས་འདུག་གོ །ཨང་གའི་རྒྱལ་པོས་རྒྱལ་པོ་པདྨ་ཆེན་པོ་ལ་ཕོ་ཉ་བཏང་སྟེ། གལ་ཏེ་ཕྱིར་འབྱུང་ན་དེ་ལྟ་ན་ལེགས། གལ་ཏེ་ཕྱིར་མི་འབྱུང་ན། ཇི་སྟེ་སྟེང་གི་ནམ་མཁའ་ལ་འགྲོ་ན་ནི།\n"  # noqa
    )

    text_2 = batch_1.get_text("1-1-4a_line_9874_2")
    assert (
        text_2
    ...
    text_3 = batch_1.get_text("1-1-4a_line_9874_3")
    assert (
        text_3
